...
2. Write a program to multiply two polynomials. (1 dimensional)
Input:
#include<stdio.h>
...
OUTPUT:
3. Write a program to addition two polynomials.(2 dimensional)
Input:
#include<stdio.h>
...
OUTPUT:
4. Write a program to addition subtraction polynomials.(2 dimensional)
Input:
#include<stdio.h>
